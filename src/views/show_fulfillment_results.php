			...
			<form
				...
				<div class="feur">
					<input type="radio" id="correct" name="fulfillment[correction]" value="correct"
						onchange="this.form.submit()" <?= ($field->getDataCorrection() == Correction::Correct) ? 'checked' : '' ?>>
					<label>Correct</label>
				</div>
				<div class="feur">
					<input type="radio" id="incorrect" name="fulfillment[correction]" value="incorrect"
						onchange="this.form.submit()" <?= ($field->getDataCorrection() == Correction::Incorrect) ? 'checked' : '' ?>>
