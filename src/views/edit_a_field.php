...
<main class="container">
	...
	<form
		...
		<div class="field">
			...
			<label for="field_answer">Answer</label>
			<input type="text" value="<?= $field->getAnswer() ?>"
				name="field[answer]" id="field_answer">
		</div>
		...
		<div class="field">
			...
			<select name="field[value_kind]" id="field_value_kind">
				...
				<option <?= $kind == Kind::ListOfSingleLines ? 'selected' : '' ?>
					value="single_line_list">List of single lines</option>
				<option <?= $kind == Kind::MultiLineText ? 'selected' : '' ?>
